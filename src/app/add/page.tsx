...
export default function Page() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!inputs.amount || !inputs.category) {
        alert("Please enter amount and category"); // todo: replace with toast
        return;
    }
    ...
    try {
      ...
      //   todo: add toast
        ...
        alert("Failed to add transaction"); // todo: replace with toast
      }
    } catch (error) {
      console.error(error);
    } finally {
  ...
  return (
    <div className="max-w-lg mx-auto w-full pb-20">
      {/*<h1 className="text-3xl font-bold mb-6 text-white px-2">Add transaction</h1>*/}
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex bg-gray-800 rounded-2xl overflow-hidden border border-gray-700 shadow-sm">
          ...
          >
            {inputs.category ? (
                ...
                <div className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center border-2 border-dashed border-gray-500">
        ...
        <div className="relative bg-gray-800 rounded-2xl border border-gray-700 hover:border-gray-600 transition-colors group">
